                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="text-sm text-white/90 font-semibold">Nivel Avanzado</div>
                          <h3 className="text-2xl font-bold text-white">{service.title}</h3>
                        </div>
                      </div>
                      <div className="bg-white text-[#2D9CDB] px-3 py-1 rounded-full text-sm font-bold shadow-sm">
                        MÁS SOLICITADO
                      </div>
                    </div>
